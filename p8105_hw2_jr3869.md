...
In the Mr. Trash Wheel dataset, there are total 216 dumpster observations with 13 variables. Some examples of key variabes include weight and volume of each dumpster and the number of plastic bottles, polystyrene, etc. that it contained. Based on the dataset, the total number of plastic bottles collected by all dumpsters is 9.27210^{5}.The median number of sports balls in a dumpster in 2016 is 26. In the precipitation dataset, the total precipitation in 2017 is 29.93. The number of observations in precipitaion 2016 is 12 and the number of observations in precipitation 2017 is 8. More precipitions happaned in 2016 compared to 2017.
